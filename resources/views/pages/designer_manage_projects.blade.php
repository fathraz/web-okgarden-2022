                            ...
                            <div class="modal-content">
                              <div class="modal-body">
                                ...
                                <div>
                                  ...
                                  <form action="/designer/project/destroy/{{ $project->id }}" method="post">
                                    @csrf
                                    <div class="text-center">
											  	...
											  	<div class="modal-dialog">
												    <div class="modal-content">
												      <div class="modal-header">
													    ...
													    <form action="/designer/project/update/{{ $project->id }}" method="post">
										            	@csrf
																	<div class="modal-body">
	  	...
	  	<div class="modal-dialog">
		    <div class="modal-content">
		      <div class="modal-header">
			    ...
			    <form action="/designer/add/project" method="post">
            	@csrf
				<div class="modal-body">
					<div class="form-group">
            <label for="name">Nama Project</label>
